...
export class ApiService {
  ...
  getTeams(): Observable<any[]> {
    return this.http.get<any[]>(`${this.base}/teams/`);
  }

  createTeam(name: string, subjectId: number): Observable<any> {
    return this.http.post<any>(`${this.base}/teams/`, { name, subject: subjectId });
  }
  ...
  addMember(teamId: number, username: string): Observable<any> {
    return this.http.post<any>(`${this.base}/teams/${teamId}/members/`, { username });
  }

  removeMember(teamId: number, userId: number): Observable<void> {
    return this.http.delete<void>(`${this.base}/teams/${teamId}/members/`, { body: { user_id: userId } });
  }

  searchUsers(query: string): Observable<User[]> {
    return this.http.get<User[]>(`${this.base}/users/search/?q=${query}`);
  }
  ...
  deleteComment(taskId: number, commentId: number): Observable<void> {
    return this.http.delete<void>(`${this.base}/tasks/${taskId}/comments/${commentId}/`);
}
...
getNotificationCount(): Observable<any> {
    return this.http.get<any>(`${this.base}/notifications/count/`);
}

markAllRead(): Observable<any> {
    return this.http.post(`${this.base}/notifications/`, {});
}
...
getTeamMembers(teamId: number): Observable<any> {
    return this.http.get<any>(`${this.base}/teams/${teamId}/`);
}

likeComment(commentId: number): Observable<any> {
    return this.http.post<any>(`${this.base}/comments/${commentId}/like/`, {});
}
}